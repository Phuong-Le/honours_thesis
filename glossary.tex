...
{
        name=marginal,
        description={Given a joint distribution  $J$ of two variables $X$ and $Y$, the marginal distribution of $X$ is the probability distribution of $X$ when $Y$ is not considered.} 
}